...
const IllustComponent: React.FC<IllustComponentProps> = ({ illust, title = "", content, isRTL = false }) => {
  return (
    <div className="grid lg:flex gap-x-24 md:gap-y-12 gap-y-0 m-auto justify-items-center items-center">
      <div className={`flex ${isRTL ? "lg:order-last" : "lg:order-first"} mt-10 md:mt-0 order-last w-3/4 md:w-auto min-w-[30%] justify-center`}><img src={illust} alt="Illustrs" /></div>
